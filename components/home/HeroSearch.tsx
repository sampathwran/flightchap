...
import { Search, MapPin, Calendar, Users, Plane, Bus, Car, Smartphone } from 'lucide-react';
...
export default function HeroSearch() {
  ...
  return (
    <div className="relative text-white min-h-[75vh] flex items-center justify-center transition-all duration-700 ease-in-out">
      ...
      {/* Content Container - Added pt-32 to account for the transparent fixed navbar */}
        ...
        <div className="bg-white rounded-xl shadow-2xl p-4 md:p-6 max-w-5xl mx-auto text-slate-800 min-h-[120px]">
          {activeTab === 0 ? (
            <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 transition-opacity duration-500">
             ...
             <div className="py-6 text-center flex flex-col items-center justify-center animate-pulse">
                <ActiveIcon className="h-10 w-10 text-slate-300 mb-2" />
                <h3 className="text-lg font-bold text-slate-700 mb-1">{tabs[activeTab].label} Search</h3>
