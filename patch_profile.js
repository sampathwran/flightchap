...
const oldMap = content.substring(content.indexOf('{promoCodes.map(promo => ('), content.indexOf('</div>\n                  )}', content.indexOf('{promoCodes.map(promo => (')));
...
content = content.replace(oldMap + '</div>', newMap);
